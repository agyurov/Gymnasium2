...
summary(luca1[[1]])
my.barplot(luca1[[1]]$beta,namez = names(luca1$resp$beta),col=3:4)
luca1o2 = model.listZ2(pred = hluca.dat1, resp = dfu["q7.1_editedprivacy"])
summary(luca1o2[[1]])
my.barplot(luca1o2[[1]]$beta,namez = names(luca1o2$resp$beta),col=grey.colors(2,start=0,end=.4,alpha = .5))
...
summary(luca3[[1]])
my.barplot(luca3[[1]]$beta,namez = names(luca3$resp$beta),col=3:4)
luca3o2 = model.listZ2(pred = hluca.dat2demo, resp = dfu["q2.1_nocare"])
summary(luca3o2[[1]])
my.barplot(luca3o2[[1]]$beta,namez = names(luca3o2$resp$beta),col=3:4)
