...
Note that $\mu(1,3) = \mu(3,1) = \mu(2,2)$ etc... The table captions include $\chi^2$ test p-values and effect size estimates based on Cliff's $\delta$.
...
fkit(am, af, col=rainbow(2,start=.6,end=0,alpha = .5))
barplot(rbindme(bm,bf),beside=T,col=rainbow(2,start=.6,end=0,alpha = .5))
fkit(bm, bf, col=rainbow(2,start=.6,end=0,alpha = .5))
barplot(rbindme(cm,cf),beside=T,col=rainbow(2,start=.6,end=0,alpha = .5))
fkit(cm, cf, col=rainbow(2,start=.6,end=0,alpha = .5))
