...
* Cliff's $\delta$ is an effect size measure for ordinal data $\in[0,1]$ and is reported with 95% confidence intervals.
...
fkit(am, af, col=rainbow(2,start=.55,end=0,alpha = .3))
barplot(rbindme(bm,bf),beside=T,col=rainbow(2,start=.55,end=0,alpha = .3))
fkit(bm, bf, col=rainbow(2,start=.55,end=0,alpha = .3))
barplot(rbindme(cm,cf),beside=T,col=rainbow(2,start=.55,end=0,alpha = .3))
fkit(cm, cf, col=rainbow(2,start=.55,end=0,alpha = .3))
legend("right",c("M", "F"), fill=rainbow(2,start=.55,end=0,alpha = .3),bty="n",horiz=F,xpd=NA)

barplot(rbindme(aja,anej),beside=T,col=grey.colors(2,.7,.3), ylab="Dig. education", xlab = "PR")
